...
const Sidebar = ({ children }: { children: React.ReactNode }) => {
  ...
  const navLinks = [
    ...
    },
    {
      icon: Code2,
      href: '/canvas',
      active: segments.includes('canvas'),
      label: 'Canvas',
    },
  ];
  ...
  return (
    <div>
      <div
        data-app-chrome
        className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-[72px] lg:flex-col border-r border-light-200 dark:border-dark-200"
      >
      ...
      <div
        data-app-chrome
        className="fixed bottom-0 w-full z-50 flex flex-row items-center gap-x-6 bg-light-secondary dark:bg-dark-secondary px-4 py-4 shadow-sm lg:hidden"
      >
        {navLinks.map((link, i) => (
          <Link
            href={link.href}
